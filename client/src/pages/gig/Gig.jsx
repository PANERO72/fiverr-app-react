...
function Gig() {
    ...
    return (<>
        {isLoading ? t("loadingContentMessage") : error ? t("somethingWentWrongContentMessage") : <><div className="topMenuShareContainer">
            <div className="topMenuShareWrapper">
                <div className="topMenu">
                    <ul>
                        <li className='navlink overview-link link'>
                            <Link1 activeClass='active' smooth={true} spy={true} offset={-200} to='overview-section'>{t("topMenuOverviewSectionLink")}</Link1>
                        </li>
                        <li className='navlink description-link link'>
                            <Link1 activeClass='active' smooth={true} spy={true} offset={-100} to='description-section'>{t("topMenuDescriptionSectionLink")}</Link1>
                        </li>
                        <li className='navlink about-link link'>
                            <Link1 activeClass='active' smooth={true} spy={true} offset={-100} to='seller-section'>{t("topMenuSellerSectionLink")}</Link1>
                        </li>                      
                        <li className='navlink reviews-link link'>
                            <Link1 activeClass='active' smooth={true} spy={true} offset={-100} to='reviews-section'>{t("topMenuReviewsSectionLink")}</Link1>
                        </li>
                    </ul>
                </div>
                        ...
                        <div className="collect-package nav-collect">
                            <div className="jEW3B9z Y_05slf">
                                <span className="HsyURQF">
                                    <button className="iyKO0_a" title={t("topShareSaveBtnTitle")}>
                ...
                <div className="gigContent">
                    <div className="left">
                        ...
                        <div className='sellerOverviewMain'>
                            {isLoadingUser ? (t("loadingContentMessage")) : errorUser ? (t("somethingWentWrongContentMessage")) : (<><div className="sellerOverviewContainer">
                        ...
                        <div className="gig-description with-translated-badge" id='description-section'>
                            <header className='gig-description-header'>
                                <h2 className="section-title">{t("gigDescriptionSectionTitle")}</h2>
                        ...
                        <div className="aboutSellerContainer" id='seller-section'>
                            {isLoadingUser ? (t("loadingContentMessage")) : errorUser ? (t("somethingWentWrongContentMessage")) : (<div className='aboutSellerWrapper'>
                                <h2 className="section-title about-the-seller"><span>{t("gigDescriptionSectionAboutSellerTitle")}</span></h2>
                                <div className="profileSellerCard">
                                    <div className="profile-info">
                                        ...
                                        <div className="user-profile-label">
                                            ...
                                            <button className="sPdE5j4 EFWC9E5 a7588_a co-grey-1000 btn-contact-me">{t("contactSellerBtn")}</button>
                                        </div>
                                    </div>
                                    <div className="stats-desc">
                                        <ul className="user-stats">
                                            <li><span>{t("userStatsInfoFrom")}</span> <strong>{dataUser.country}</strong></li>
                                            <li><span>{t("userStatsInfoMemberSince")}</span> <strong>ene 2023</strong></li>
                                            <li><span>{t("userStatsInfoAnswerApprox")}</span> <strong>1 hora</strong></li>
                                            <li><span>{t("userStatsInfoLastDeliveryApprox")}</span> <strong>4 horas</strong></li>
                                            <li>
                                                <span>{t("userStatsInfoLanguages")}</span>
                                                <div className="jEW3B9z Y_05slf languages-tooltip" title={t("userStatsInfoLanguagesTitle")}>
                                                    <span className="HsyURQF">
                                                        <strong data-testid="languages-to-show" className="Y_05slf languages-tooltip" delay="120" content="[object Object]" position="top" boxclassnamename="n8k5Ydl" boxcontentclassnamename="xZqc_Ec">{t("userStatsInfoLanguagesText")}</strong>
                                                    </span>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <aside className="sidebar-content">
                                    ...
                                    <div className="package-content zxTHQ6r">
                                        <header className="header-default">
                                            <div className="content-tab">
                                                <h3>
                                                    <b className="title">{t("packagesContentBasicTitle")} &mdash; {data.shortTitle}</b>
                                        ...
                                        <article>
                                            <div className="additional-info">
                                                <div className="delivery-wrapper">
                                                    ...
                                                    <b className="delivery">{t("packagesContentDeliveryTime")} &nbsp; {data.deliveryTime} {t("packagesContentDeliveryDays")}</b>
                                                </div>
                                                {isActiveRevision && <div className="revisions-wrapper">
                                                    ...
                                                    <b className="revisions">{data.revisionNumber} {t("packagesContentRevisions")}</b>
                                                </div>}
                                            </div>
                            ...
                            <div className="contact-seller">
                                <div className="contact-seller-wrapper">
                                    <button className="sPdE5j4 EFWC9E5 a7588_a co-grey-1000 btn-contact-seller" tabIndex="0">{t("contactSellerBtn")}</button>
                                </div>
                            </div>
                        </aside>
                    </div>
