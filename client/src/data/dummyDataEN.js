...
export const testimonialsEN = [
  {
    ...
    title: "Tim and Dan Joo, cofounders",
    desc: "\"When you want to build a business bigger than you can manage, you need a lot of help. That's what Fiverr does.\".",
  },
  {
    id: 2,
    ...
    title: "Brighid Gannon (DNP, PMHNP-BC), cofounder",
    desc: "\"We use Fiverr for SEO, logo, website, content, animated videos. Literally for everything. It's like working with a person who is right next to you, and not with someone who is on the other side of the world\".",
  },
  {
    id: 3,
    ...
    title: "Kay Kim, cofounder",
    desc: "\"It is very exciting that Fiverr has freelancers from all over the world. Expand the talent pool. One of the best things about Fiverr is that while we sleep, someone is working\".",
  },
  {
    id: 4,
    ...
    title: "Caitlin Tormey, commercial director",
    desc: "\"We use Fiverr for Shopify web development, graphic design and backend development. Working with Fiverr makes my job a little easier every day\".",
  }
];

/*************************************** */
export const gigsCategoryEN = [
  {
    id: 1, 
    title: "Graphic Arts and Design", 
    cat: "graphics-design",
  },
  {
    id: 2, 
